...
jQuery(($) => {
  ...
  $(".Pricing-toggle-button").on("click", function () {
    var opt = 1;
    if ($(this).hasClass("p1")) {
      $("#pricing-img").attr("src", "images/price-1.png");

      opt = 1;
    } else if ($(this).hasClass("p2")) {
      $("#pricing-img").attr("src", "images/price-2.png");
      opt = 2;
    }
    else {
      $("#pricing-img").attr("src", "images/price-3.png");
      opt = 3;
    }
    $("#pricing-img").attr("width", "70%");
    ...
    .revolution({
      ...
      navigation: {
        ...
        bullets: {
          ...
          space: 5,
          tmp:
            '<div class="tp-bullet-number"><span class="tp-count">{{param1}}</span><span class="tp-bullet-line"></span></div>',
        },
        arrows: {
          style: "",
          enable: false,
